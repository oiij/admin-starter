...
declare module '~virtual/svg-component' {
  ...
  export const svgNames: ["icon-ai-editor", "icon-charts", "icon-code", "icon-home", "icon-naive", "icon-super", "icon-window"];
  export type SvgName = "icon-ai-editor" | "icon-charts" | "icon-code" | "icon-home" | "icon-naive" | "icon-super" | "icon-window";
